...
const
  INT0 = 0;  m_INT0 = 1;  // External Interrupt Mask
  INT1 = 1;  m_INT1 = 2;  // External Interrupt Mask
  INT2 = 2;  m_INT2 = 4;  // External Interrupt Mask
  INT3 = 3;  m_INT3 = 8;  // External Interrupt Mask
...
type
  TGTCCRset = bitpacked set of (e_PSRSYNC, e_ICPSEL1=6, e_TSM);
...
const
  OCR0A0 = 0;  m_OCR0A0 = 1;  // Output Compare A value
  OCR0A1 = 1;  m_OCR0A1 = 2;  // Output Compare A value
  OCR0A2 = 2;  m_OCR0A2 = 4;  // Output Compare A value
  OCR0A3 = 3;  m_OCR0A3 = 8;  // Output Compare A value
  OCR0A4 = 4;  m_OCR0A4 = 16;  // Output Compare A value
  OCR0A5 = 5;  m_OCR0A5 = 32;  // Output Compare A value
  OCR0A6 = 6;  m_OCR0A6 = 64;  // Output Compare A value
  OCR0A7 = 7;  m_OCR0A7 = 128;  // Output Compare A value
...
const
  OCR0B0 = 0;  m_OCR0B0 = 1;  // Output Compare B value
  OCR0B1 = 1;  m_OCR0B1 = 2;  // Output Compare B value
  OCR0B2 = 2;  m_OCR0B2 = 4;  // Output Compare B value
  OCR0B3 = 3;  m_OCR0B3 = 8;  // Output Compare B value
  OCR0B4 = 4;  m_OCR0B4 = 16;  // Output Compare B value
  OCR0B5 = 5;  m_OCR0B5 = 32;  // Output Compare B value
  OCR0B6 = 6;  m_OCR0B6 = 64;  // Output Compare B value
  OCR0B7 = 7;  m_OCR0B7 = 128;  // Output Compare B value
...
const
  SPD0 = 0;  m_SPD0 = 1;  // SPI Data
  SPD1 = 1;  m_SPD1 = 2;  // SPI Data
  SPD2 = 2;  m_SPD2 = 4;  // SPI Data
  SPD3 = 3;  m_SPD3 = 8;  // SPI Data
  SPD4 = 4;  m_SPD4 = 16;  // SPI Data
  SPD5 = 5;  m_SPD5 = 32;  // SPI Data
  SPD6 = 6;  m_SPD6 = 64;  // SPI Data
  SPD7 = 7;  m_SPD7 = 128;  // SPI Data
...
const
  ADTS0 = 0;  m_ADTS0 = 1;  // ADC Auto Trigger Source Selection 0
  ADTS1 = 1;  m_ADTS1 = 2;  // ADC Auto Trigger Source Selection 1
  ADTS2 = 2;  m_ADTS2 = 4;  // ADC Auto Trigger Source Selection 2
  ADTS3 = 3;  m_ADTS3 = 8;  // ADC Auto Trigger Source Selection 3
...
const
  ICR10 = 0;  m_ICR10 = 1;  // Timer/Counter Input Capture
  ICR11 = 1;  m_ICR11 = 2;  // Timer/Counter Input Capture
  ICR12 = 2;  m_ICR12 = 4;  // Timer/Counter Input Capture
  ICR13 = 3;  m_ICR13 = 8;  // Timer/Counter Input Capture
  ICR14 = 4;  m_ICR14 = 16;  // Timer/Counter Input Capture
  ICR15 = 5;  m_ICR15 = 32;  // Timer/Counter Input Capture
  ICR16 = 6;  m_ICR16 = 64;  // Timer/Counter Input Capture
  ICR17 = 7;  m_ICR17 = 128;  // Timer/Counter Input Capture
...
const
  OCR1A0 = 0;  m_OCR1A0 = 1;  // Timer/Counter1 Output Compare A Register
  OCR1A1 = 1;  m_OCR1A1 = 2;  // Timer/Counter1 Output Compare A Register
  OCR1A2 = 2;  m_OCR1A2 = 4;  // Timer/Counter1 Output Compare A Register
  OCR1A3 = 3;  m_OCR1A3 = 8;  // Timer/Counter1 Output Compare A Register
  OCR1A4 = 4;  m_OCR1A4 = 16;  // Timer/Counter1 Output Compare A Register
  OCR1A5 = 5;  m_OCR1A5 = 32;  // Timer/Counter1 Output Compare A Register
  OCR1A6 = 6;  m_OCR1A6 = 64;  // Timer/Counter1 Output Compare A Register
  OCR1A7 = 7;  m_OCR1A7 = 128;  // Timer/Counter1 Output Compare A Register
...
const
  OCR1B0 = 0;  m_OCR1B0 = 1;  // Timer/Counter1 Output Compare B Register
  OCR1B1 = 1;  m_OCR1B1 = 2;  // Timer/Counter1 Output Compare B Register
  OCR1B2 = 2;  m_OCR1B2 = 4;  // Timer/Counter1 Output Compare B Register
  OCR1B3 = 3;  m_OCR1B3 = 8;  // Timer/Counter1 Output Compare B Register
  OCR1B4 = 4;  m_OCR1B4 = 16;  // Timer/Counter1 Output Compare B Register
  OCR1B5 = 5;  m_OCR1B5 = 32;  // Timer/Counter1 Output Compare B Register
  OCR1B6 = 6;  m_OCR1B6 = 64;  // Timer/Counter1 Output Compare B Register
  OCR1B7 = 7;  m_OCR1B7 = 128;  // Timer/Counter1 Output Compare B Register
...
var
  DAC: word absolute $AB;  // DAC Data Register Bytes
...
var
  UBRRL: byte absolute $C4;  // USART Baud Rate Register Low Byte

type
  TUBRRHset = bitpacked set of (e_UBRR8, e_UBRR9, e_UBRR10, e_UBRR11);
...
var
  UBRRH: byte absolute $C5;  // USART Baud Rate Register High Byte
  UBRRHset: TUBRRHset absolute $C5;
  UBRRHrec: TUBRRHrec absolute $C5;
const
  UBRR8 = 0;  m_UBRR8 = 1;  // USART Baud Rate Register Bits
  UBRR9 = 1;  m_UBRR9 = 2;  // USART Baud Rate Register Bits
  UBRR10 = 2;  m_UBRR10 = 4;  // USART Baud Rate Register Bits
  UBRR11 = 3;  m_UBRR11 = 8;  // USART Baud Rate Register Bits
...
var
  MUBRRL: byte absolute $CC;  // Manchester Receiver Baud Rate Register Low Byte

type
  TMUBRRHset = bitpacked set of (e_MUBRR8, e_MUBRR9, e_MUBRR10, e_MUBRR11, e_MUBRR12, e_MUBRR13, e_MUBRR14, e_MUBRR15);
  TMUBRRHrec = bitpacked record
    MUBRR8,
    MUBRR9,
    MUBRR10,
    MUBRR11,
...
var
  MUBRRH: byte absolute $CD;  // Manchester Receiver Baud Rate Register High Byte
  MUBRRHset: TMUBRRHset absolute $CD;
  MUBRRHrec: TMUBRRHrec absolute $CD;
const
  MUBRR8 = 0;  m_MUBRR8 = 1;  // Manchester Receiver Baud Rate Register Bits
  MUBRR9 = 1;  m_MUBRR9 = 2;  // Manchester Receiver Baud Rate Register Bits
  MUBRR10 = 2;  m_MUBRR10 = 4;  // Manchester Receiver Baud Rate Register Bits
  MUBRR11 = 3;  m_MUBRR11 = 8;  // Manchester Receiver Baud Rate Register Bits
  MUBRR12 = 4;  m_MUBRR12 = 16;  // Manchester Receiver Baud Rate Register Bits
  MUBRR13 = 5;  m_MUBRR13 = 32;  // Manchester Receiver Baud Rate Register Bits
  MUBRR14 = 6;  m_MUBRR14 = 64;  // Manchester Receiver Baud Rate Register Bits
  MUBRR15 = 7;  m_MUBRR15 = 128;  // Manchester Receiver Baud Rate Register Bits
...
var
  OCR0SA: word absolute $D2;  // Output Compare SA Register 
  OCR0SAL: byte absolute $D2;
  OCR0SAH: byte absolute $D3;
  OCR0RA: word absolute $D4;  // Output Compare RA Register 
  OCR0RAL: byte absolute $D4;
  OCR0RAH: byte absolute $D5;
  OCR0SB: word absolute $D6;  // Output Compare SB Register 
  OCR0SBL: byte absolute $D6;
  OCR0SBH: byte absolute $D7;
  OCR0RB: word absolute $D8;  // Output Compare RB Register 
...
var
  OCR2SA: word absolute $F2;  // Output Compare SA Register 
  OCR2SAL: byte absolute $F2;
  OCR2SAH: byte absolute $F3;
  OCR2RA: word absolute $F4;  // Output Compare RA Register 
  OCR2RAL: byte absolute $F4;
  OCR2RAH: byte absolute $F5;
  OCR2SB: word absolute $F6;  // Output Compare SB Register 
  OCR2SBL: byte absolute $F6;
  OCR2SBH: byte absolute $F7;
  OCR2RB: word absolute $F8;  // Output Compare RB Register 
