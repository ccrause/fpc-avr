...
var
  DACL: byte absolute $58;  // DAC Data Register Low Byte
  DACLset: TDACLset absolute $58;
  DACLrec: TDACLrec absolute $58;
const
...
var
  DACH: byte absolute $59;  // DAC Data Register High Byte
  DACHset: TDACHset absolute $59;
  DACHrec: TDACHrec absolute $59;
const
...
var
  PICR2L: byte absolute $6C;  // PSC 2 Input Capture Register Low

type
  TPICR2Hset = bitpacked set of (e_PICR28, e_PICR29, e_PICR210, e_PICR211, e_PCST2=7);
  TPICR2Hrec = bitpacked record
    PICR28,
    PICR29,
    PICR210,
    PICR211,
...
var
  PICR2H: byte absolute $6D;  // PSC 2 Input Capture Register High
  PICR2Hset: TPICR2Hset absolute $6D;
  PICR2Hrec: TPICR2Hrec absolute $6D;
const
  PICR28 = 0;  m_PICR28 = 1;
  PICR29 = 1;  m_PICR29 = 2;
  PICR210 = 2;  m_PICR210 = 4;
  PICR211 = 3;  m_PICR211 = 8;
  PCST2 = 7;  m_PCST2 = 128;  // PSC 2 Capture Software Trigger Bit
...
const
  ...
  ADC6D = 6;  m_ADC6D = 64;  // ADC7 Digital input Disable
  ADC7D = 7;  m_ADC7D = 128;

type
  TDIDR1set = bitpacked set of (e_ADC9D, e_ADC10D, e_AMP0POSD, e_ACMP1MD);
...
var
  DIDR1: byte absolute $78;  // Digital Input Disable Register 0
  DIDR1set: TDIDR1set absolute $78;
  DIDR1rec: TDIDR1rec absolute $78;
const
  ADC9D = 0;  m_ADC9D = 1;
  ADC10D = 1;  m_ADC10D = 2;
  AMP0POSD = 2;  m_AMP0POSD = 4;
