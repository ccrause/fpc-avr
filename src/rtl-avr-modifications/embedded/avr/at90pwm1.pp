...
type
  TADCSRBset = bitpacked set of (e_ADTS0, e_ADTS1, e_ADTS2, e_ADTS3, e_ADASCR, e_ADHSM=7);
...
const
  ...
  ADASCR = 4;  m_ADASCR = 16;  // ADC Start Conversion
...
type
  TPIFR0set = bitpacked set of (e_PEOP0, e_PRN00, e_PRN01, e_PEV0A, e_PEV0B, e_PSEI0);
...
type
  TPIFR2set = bitpacked set of (e_PEOP2, e_PRN20, e_PRN21, e_PEV2A, e_PEV2B, e_PSEI2);
...
const
  PICR00 = 0;  m_PICR00 = 1;  // PSC 0 Capture Register
  PICR01 = 1;  m_PICR01 = 2;  // PSC 0 Capture Register
  PICR02 = 2;  m_PICR02 = 4;  // PSC 0 Capture Register
  PICR03 = 3;  m_PICR03 = 8;  // PSC 0 Capture Register
  PICR04 = 4;  m_PICR04 = 16;  // PSC 0 Capture Register
  PICR05 = 5;  m_PICR05 = 32;  // PSC 0 Capture Register
  PICR06 = 6;  m_PICR06 = 64;  // PSC 0 Capture Register
  PICR07 = 7;  m_PICR07 = 128;  // PSC 0 Capture Register

type
  TPSOC1set = bitpacked set of (e_POEN1A, e_POEN1B=2, e_PSYNC10=4, e_PSYNC11);
...
const
  ...
  PSYNC10 = 4;  m_PSYNC10 = 16;  // Synchronization Out for ADC Selection
  PSYNC11 = 5;  m_PSYNC11 = 32;  // Synchronization Out for ADC Selection
...
const
  PICR20 = 0;  m_PICR20 = 1;  // PSC 2 Input Capture Register
  PICR21 = 1;  m_PICR21 = 2;  // PSC 2 Input Capture Register
  PICR22 = 2;  m_PICR22 = 4;  // PSC 2 Input Capture Register
  PICR23 = 3;  m_PICR23 = 8;  // PSC 2 Input Capture Register
  PICR24 = 4;  m_PICR24 = 16;  // PSC 2 Input Capture Register
  PICR25 = 5;  m_PICR25 = 32;  // PSC 2 Input Capture Register
  PICR26 = 6;  m_PICR26 = 64;  // PSC 2 Input Capture Register
  PICR27 = 7;  m_PICR27 = 128;  // PSC 2 Input Capture Register
  // typedefs = 65
