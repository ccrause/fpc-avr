...
type
  TFESRset = bitpacked set of (e_LBSAT, e_HBSAT, e_XRDY, e_PLCK);
...
type
  TFEEN2set = bitpacked set of (e_SDRX, e_SDRX2, e_PAEN, e_TMPM, e_PLPEN, e_XTPEN);
...
const
  ...
  SDRX2 = 1;  m_SDRX2 = 2;  // Single Pole Double Throw (SPDT) Switch TX
