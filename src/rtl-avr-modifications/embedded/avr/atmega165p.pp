...
type
  TEIFRset = bitpacked set of (e_INTF0, e_PCIF0=6, e_PCIF1);
...
const
  ...
  PCIF0 = 6;  m_PCIF0 = 64;  // Pin Change Interrupt Flags
  PCIF1 = 7;  m_PCIF1 = 128;  // Pin Change Interrupt Flags

type
  TEIMSKset = bitpacked set of (e_INT0, e_PCIE0=6, e_PCIE1);
...
const
  ...
  PCIE0 = 6;  m_PCIE0 = 64;  // Pin Change Interrupt Enables
  PCIE1 = 7;  m_PCIE1 = 128;  // Pin Change Interrupt Enables
