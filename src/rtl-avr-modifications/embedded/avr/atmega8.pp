...
type
  TADCSRAset = bitpacked set of (e_ADPS0, e_ADPS1, e_ADPS2, e_ADIE, e_ADIF, e_ADFR, e_ADSC, e_ADEN);
...
type
  TSFIORset = bitpacked set of (e_PSR10, e_PSR2, e_PUD, e_ACME, e_ADHSM);
...
const
  ...
  ADHSM = 4;  m_ADHSM = 16;  // ADC High Speed Mode
...
type
  TMCUCSRset = bitpacked set of (e_PORF, e_EXTRF, e_BORF, e_WDRF);
...
type
  TTIFRset = bitpacked set of (e_TOV0, e_TOV1=2, e_OCF1B, e_OCF1A, e_ICF1, e_TOV2, e_OCF2);
...
type
  TTIMSKset = bitpacked set of (e_TOIE0, e_TOIE1=2, e_OCIE1B, e_OCIE1A, e_TICIE1, e_TOIE2, e_OCIE2);
...
type
  TGIFRset = bitpacked set of (e_INTF0=6, e_INTF1);
...
type
  TGICRset = bitpacked set of (e_IVCE, e_IVSEL, e_INT0=6, e_INT1);
