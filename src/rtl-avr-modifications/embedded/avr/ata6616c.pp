...
const
  CAL0 = 0;  m_CAL0 = 1;  // Oscillator Calibration Register bits
  CAL1 = 1;  m_CAL1 = 2;  // Oscillator Calibration Register bits
  CAL2 = 2;  m_CAL2 = 4;  // Oscillator Calibration Register bits
  CAL3 = 3;  m_CAL3 = 8;  // Oscillator Calibration Register bits
  CAL4 = 4;  m_CAL4 = 16;  // Oscillator Calibration Register bits
  CAL5 = 5;  m_CAL5 = 32;  // Oscillator Calibration Register bits
  CAL6 = 6;  m_CAL6 = 64;  // Oscillator Calibration Register bits
  CAL7 = 7;  m_CAL7 = 128;  // Oscillator Calibration Register bits
