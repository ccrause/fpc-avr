...
const
  PCINT0 = 0;  m_PCINT0 = 1;  // Pin Change Mask Register pin 0
  PCINT1 = 1;  m_PCINT1 = 2;  // Pin Change Mask Register pin 1
  PCINT2 = 2;  m_PCINT2 = 4;  // Pin Change Mask Register pin 2
  PCINT3 = 3;  m_PCINT3 = 8;  // Pin Change Mask Register pin 3
  PCINT4 = 4;  m_PCINT4 = 16;  // Pin Change Mask Register pin 4
  PCINT5 = 5;  m_PCINT5 = 32;  // Pin Change Mask Register pin 5
  PCINT6 = 6;  m_PCINT6 = 64;  // Pin Change Mask Register pin 6
  PCINT7 = 7;  m_PCINT7 = 128;  // Pin Change Mask Register pin 7
...
const
  PCINT8 = 0;  m_PCINT8 = 1;  // Pin Change Mask Register pin 8
  PCINT9 = 1;  m_PCINT9 = 2;  // Pin Change Mask Register pin 9
  PCINT10 = 2;  m_PCINT10 = 4;  // Pin Change Mask Register pin 10
  PCINT11 = 3;  m_PCINT11 = 8;  // Pin Change Mask Register pin 11
  PCINT12 = 4;  m_PCINT12 = 16;  // Pin Change Mask Register pin 12
  PCINT13 = 5;  m_PCINT13 = 32;  // Pin Change Mask Register pin 13
  PCINT14 = 6;  m_PCINT14 = 64;  // Pin Change Mask Register pin 14
  PCINT15 = 7;  m_PCINT15 = 128;  // Pin Change Mask Register pin 15
...
const
  ...
  LCDDC0 = 5;  m_LCDDC0 = 32;
  LCDDC1 = 6;  m_LCDDC1 = 64;
  LCDDC2 = 7;  m_LCDDC2 = 128;

type
  TLCDDR0set = bitpacked set of (e_SEG000, e_SEG001, e_SEG002, e_SEG003, e_SEG004, e_SEG005, e_SEG006, e_SEG007);
  TLCDDR0rec = bitpacked record
    SEG000,
    SEG001,
    SEG002,
    SEG003,
...
var
  ...
  LCDDR0set: TLCDDR0set absolute $EC;
  LCDDR0rec: TLCDDR0rec absolute $EC;
const
  SEG000 = 0;  m_SEG000 = 1;  // LCD memory bit segment
  SEG001 = 1;  m_SEG001 = 2;  // LCD memory bit segment
  SEG002 = 2;  m_SEG002 = 4;  // LCD memory bit segment
  SEG003 = 3;  m_SEG003 = 8;  // LCD memory bit segment
  SEG004 = 4;  m_SEG004 = 16;  // LCD memory bit segment
  SEG005 = 5;  m_SEG005 = 32;  // LCD memory bit segment
  SEG006 = 6;  m_SEG006 = 64;  // LCD memory bit segment
  SEG007 = 7;  m_SEG007 = 128;  // LCD memory bit segment

type
  TLCDDR1set = bitpacked set of (e_SEG008, e_SEG009, e_SEG010, e_SEG011, e_SEG012, e_SEG013, e_SEG014, e_SEG015);
  TLCDDR1rec = bitpacked record
    SEG008,
    SEG009,
    SEG010,
    SEG011,
...
var
  ...
  LCDDR1set: TLCDDR1set absolute $ED;
  LCDDR1rec: TLCDDR1rec absolute $ED;
const
  SEG008 = 0;  m_SEG008 = 1;  // LCD memory bit segment
  SEG009 = 1;  m_SEG009 = 2;  // LCD memory bit segment
  SEG010 = 2;  m_SEG010 = 4;  // LCD memory bit segment
  SEG011 = 3;  m_SEG011 = 8;  // LCD memory bit segment
  SEG012 = 4;  m_SEG012 = 16;  // LCD memory bit segment
  SEG013 = 5;  m_SEG013 = 32;  // LCD memory bit segment
  SEG014 = 6;  m_SEG014 = 64;  // LCD memory bit segment
  SEG015 = 7;  m_SEG015 = 128;  // LCD memory bit segment

type
  TLCDDR2set = bitpacked set of (e_SEG016, e_SEG017, e_SEG018, e_SEG019, e_SEG020, e_SEG021, e_SEG022, e_SEG023);
  TLCDDR2rec = bitpacked record
    SEG016,
    SEG017,
    SEG018,
    SEG019,
...
var
  ...
  LCDDR2set: TLCDDR2set absolute $EE;
  LCDDR2rec: TLCDDR2rec absolute $EE;
const
  SEG016 = 0;  m_SEG016 = 1;  // LCD memory bit segment
  SEG017 = 1;  m_SEG017 = 2;  // LCD memory bit segment
  SEG018 = 2;  m_SEG018 = 4;  // LCD memory bit segment
  SEG019 = 3;  m_SEG019 = 8;  // LCD memory bit segment
  SEG020 = 4;  m_SEG020 = 16;  // LCD memory bit segment
  SEG021 = 5;  m_SEG021 = 32;  // LCD memory bit segment
  SEG022 = 6;  m_SEG022 = 64;  // LCD memory bit segment
  SEG023 = 7;  m_SEG023 = 128;  // LCD memory bit segment

type
  TLCDDR3set = bitpacked set of (e_SEG024, e_SEG025, e_SEG026, e_SEG027, e_SEG028, e_SEG029, e_SEG030, e_SEG031);
  TLCDDR3rec = bitpacked record
    SEG024,
    SEG025,
    SEG026,
    SEG027,
...
var
  ...
  LCDDR3set: TLCDDR3set absolute $EF;
  LCDDR3rec: TLCDDR3rec absolute $EF;
const
  SEG024 = 0;  m_SEG024 = 1;  // LCD memory bit segment
  SEG025 = 1;  m_SEG025 = 2;  // LCD memory bit segment
  SEG026 = 2;  m_SEG026 = 4;  // LCD memory bit segment
  SEG027 = 3;  m_SEG027 = 8;  // LCD memory bit segment
  SEG028 = 4;  m_SEG028 = 16;  // LCD memory bit segment
  SEG029 = 5;  m_SEG029 = 32;  // LCD memory bit segment
  SEG030 = 6;  m_SEG030 = 64;  // LCD memory bit segment
  SEG031 = 7;  m_SEG031 = 128;  // LCD memory bit segment

type
  TLCDDR5set = bitpacked set of (e_SEG100, e_SEG101, e_SEG102, e_SEG103, e_SEG104, e_SEG105, e_SEG106, e_SEG107);
  TLCDDR5rec = bitpacked record
    SEG100,
    SEG101,
    SEG102,
    SEG103,
...
var
  ...
  LCDDR5set: TLCDDR5set absolute $F1;
  LCDDR5rec: TLCDDR5rec absolute $F1;
const
  SEG100 = 0;  m_SEG100 = 1;  // LCD memory bit segment
  SEG101 = 1;  m_SEG101 = 2;  // LCD memory bit segment
  SEG102 = 2;  m_SEG102 = 4;  // LCD memory bit segment
  SEG103 = 3;  m_SEG103 = 8;  // LCD memory bit segment
  SEG104 = 4;  m_SEG104 = 16;  // LCD memory bit segment
  SEG105 = 5;  m_SEG105 = 32;  // LCD memory bit segment
  SEG106 = 6;  m_SEG106 = 64;  // LCD memory bit segment
  SEG107 = 7;  m_SEG107 = 128;  // LCD memory bit segment

type
  TLCDDR6set = bitpacked set of (e_SEG108, e_SEG109, e_SEG110, e_SEG111, e_SEG112, e_SEG113, e_SEG114, e_SEG115);
  TLCDDR6rec = bitpacked record
    SEG108,
    SEG109,
    SEG110,
    SEG111,
...
var
  ...
  LCDDR6set: TLCDDR6set absolute $F2;
  LCDDR6rec: TLCDDR6rec absolute $F2;
const
  SEG108 = 0;  m_SEG108 = 1;  // LCD memory bit segment
  SEG109 = 1;  m_SEG109 = 2;  // LCD memory bit segment
  SEG110 = 2;  m_SEG110 = 4;  // LCD memory bit segment
  SEG111 = 3;  m_SEG111 = 8;  // LCD memory bit segment
  SEG112 = 4;  m_SEG112 = 16;  // LCD memory bit segment
  SEG113 = 5;  m_SEG113 = 32;  // LCD memory bit segment
  SEG114 = 6;  m_SEG114 = 64;  // LCD memory bit segment
  SEG115 = 7;  m_SEG115 = 128;  // LCD memory bit segment

type
  TLCDDR7set = bitpacked set of (e_SEG116, e_SEG117, e_SEG118, e_SEG119, e_SEG120, e_SEG121, e_SEG122, e_SEG123);
  TLCDDR7rec = bitpacked record
    SEG116,
    SEG117,
    SEG118,
    SEG119,
...
var
  ...
  LCDDR7set: TLCDDR7set absolute $F3;
  LCDDR7rec: TLCDDR7rec absolute $F3;
const
  SEG116 = 0;  m_SEG116 = 1;  // LCD memory bit segment
  SEG117 = 1;  m_SEG117 = 2;  // LCD memory bit segment
  SEG118 = 2;  m_SEG118 = 4;  // LCD memory bit segment
  SEG119 = 3;  m_SEG119 = 8;  // LCD memory bit segment
  SEG120 = 4;  m_SEG120 = 16;  // LCD memory bit segment
  SEG121 = 5;  m_SEG121 = 32;  // LCD memory bit segment
  SEG122 = 6;  m_SEG122 = 64;  // LCD memory bit segment
  SEG123 = 7;  m_SEG123 = 128;  // LCD memory bit segment

type
  TLCDDR8set = bitpacked set of (e_SEG124, e_SEG125, e_SEG126, e_SEG127, e_SEG128, e_SEG129, e_SEG130, e_SEG131);
  TLCDDR8rec = bitpacked record
    SEG124,
    SEG125,
    SEG126,
    SEG127,
...
var
  ...
  LCDDR8set: TLCDDR8set absolute $F4;
  LCDDR8rec: TLCDDR8rec absolute $F4;
const
  SEG124 = 0;  m_SEG124 = 1;  // LCD memory bit segment
  SEG125 = 1;  m_SEG125 = 2;  // LCD memory bit segment
  SEG126 = 2;  m_SEG126 = 4;  // LCD memory bit segment
  SEG127 = 3;  m_SEG127 = 8;  // LCD memory bit segment
  SEG128 = 4;  m_SEG128 = 16;  // LCD memory bit segment
  SEG129 = 5;  m_SEG129 = 32;  // LCD memory bit segment
  SEG130 = 6;  m_SEG130 = 64;  // LCD memory bit segment
  SEG131 = 7;  m_SEG131 = 128;  // LCD memory bit segment

type
  TLCDDR10set = bitpacked set of (e_SEG200, e_SEG201, e_SEG202, e_SEG203, e_SEG204, e_SEG205, e_SEG206, e_SEG207);
  TLCDDR10rec = bitpacked record
    SEG200,
    SEG201,
    SEG202,
    SEG203,
...
var
  ...
  LCDDR10set: TLCDDR10set absolute $F6;
  LCDDR10rec: TLCDDR10rec absolute $F6;
const
  SEG200 = 0;  m_SEG200 = 1;  // LCD memory bit segment
  SEG201 = 1;  m_SEG201 = 2;  // LCD memory bit segment
  SEG202 = 2;  m_SEG202 = 4;  // LCD memory bit segment
  SEG203 = 3;  m_SEG203 = 8;  // LCD memory bit segment
  SEG204 = 4;  m_SEG204 = 16;  // LCD memory bit segment
  SEG205 = 5;  m_SEG205 = 32;  // LCD memory bit segment
  SEG206 = 6;  m_SEG206 = 64;  // LCD memory bit segment
  SEG207 = 7;  m_SEG207 = 128;  // LCD memory bit segment

type
  TLCDDR11set = bitpacked set of (e_SEG208, e_SEG209, e_SEG210, e_SEG211, e_SEG212, e_SEG213, e_SEG214, e_SEG215);
  TLCDDR11rec = bitpacked record
    SEG208,
    SEG209,
    SEG210,
    SEG211,
...
var
  ...
  LCDDR11set: TLCDDR11set absolute $F7;
  LCDDR11rec: TLCDDR11rec absolute $F7;
const
  SEG208 = 0;  m_SEG208 = 1;  // LCD memory bit segment
  SEG209 = 1;  m_SEG209 = 2;  // LCD memory bit segment
  SEG210 = 2;  m_SEG210 = 4;  // LCD memory bit segment
  SEG211 = 3;  m_SEG211 = 8;  // LCD memory bit segment
  SEG212 = 4;  m_SEG212 = 16;  // LCD memory bit segment
  SEG213 = 5;  m_SEG213 = 32;  // LCD memory bit segment
  SEG214 = 6;  m_SEG214 = 64;  // LCD memory bit segment
  SEG215 = 7;  m_SEG215 = 128;  // LCD memory bit segment

type
  TLCDDR12set = bitpacked set of (e_SEG216, e_SEG217, e_SEG218, e_SEG219, e_SEG220, e_SEG221, e_SEG222, e_SEG223);
  TLCDDR12rec = bitpacked record
    SEG216,
    SEG217,
    SEG218,
    SEG219,
...
var
  ...
  LCDDR12set: TLCDDR12set absolute $F8;
  LCDDR12rec: TLCDDR12rec absolute $F8;
const
  SEG216 = 0;  m_SEG216 = 1;  // LCD memory bit segment
  SEG217 = 1;  m_SEG217 = 2;  // LCD memory bit segment
  SEG218 = 2;  m_SEG218 = 4;  // LCD memory bit segment
  SEG219 = 3;  m_SEG219 = 8;  // LCD memory bit segment
  SEG220 = 4;  m_SEG220 = 16;  // LCD memory bit segment
  SEG221 = 5;  m_SEG221 = 32;  // LCD memory bit segment
  SEG222 = 6;  m_SEG222 = 64;  // LCD memory bit segment
  SEG223 = 7;  m_SEG223 = 128;  // LCD memory bit segment

type
  TLCDDR13set = bitpacked set of (e_SEG224, e_SEG225, e_SEG226, e_SEG227, e_SEG228, e_SEG229, e_SEG230, e_SEG231);
  TLCDDR13rec = bitpacked record
    SEG224,
    SEG225,
    SEG226,
    SEG227,
...
var
  ...
  LCDDR13set: TLCDDR13set absolute $F9;
  LCDDR13rec: TLCDDR13rec absolute $F9;
const
  SEG224 = 0;  m_SEG224 = 1;  // LCD memory bit segment
  SEG225 = 1;  m_SEG225 = 2;  // LCD memory bit segment
  SEG226 = 2;  m_SEG226 = 4;  // LCD memory bit segment
  SEG227 = 3;  m_SEG227 = 8;  // LCD memory bit segment
  SEG228 = 4;  m_SEG228 = 16;  // LCD memory bit segment
  SEG229 = 5;  m_SEG229 = 32;  // LCD memory bit segment
  SEG230 = 6;  m_SEG230 = 64;  // LCD memory bit segment
  SEG231 = 7;  m_SEG231 = 128;  // LCD memory bit segment

type
  TLCDDR15set = bitpacked set of (e_SEG300, e_SEG301, e_SEG302, e_SEG303, e_SEG304, e_SEG305, e_SEG306, e_SEG307);
  TLCDDR15rec = bitpacked record
    SEG300,
    SEG301,
    SEG302,
    SEG303,
...
var
  ...
  LCDDR15set: TLCDDR15set absolute $FB;
  LCDDR15rec: TLCDDR15rec absolute $FB;
const
  SEG300 = 0;  m_SEG300 = 1;  // LCD memory bit segment
  SEG301 = 1;  m_SEG301 = 2;  // LCD memory bit segment
  SEG302 = 2;  m_SEG302 = 4;  // LCD memory bit segment
  SEG303 = 3;  m_SEG303 = 8;  // LCD memory bit segment
  SEG304 = 4;  m_SEG304 = 16;  // LCD memory bit segment
  SEG305 = 5;  m_SEG305 = 32;  // LCD memory bit segment
  SEG306 = 6;  m_SEG306 = 64;  // LCD memory bit segment
  SEG307 = 7;  m_SEG307 = 128;  // LCD memory bit segment

type
  TLCDDR16set = bitpacked set of (e_SEG308, e_SEG309, e_SEG310, e_SEG311, e_SEG312, e_SEG313, e_SEG314, e_SEG315);
  TLCDDR16rec = bitpacked record
    SEG308,
    SEG309,
    SEG310,
    SEG311,
...
var
  ...
  LCDDR16set: TLCDDR16set absolute $FC;
  LCDDR16rec: TLCDDR16rec absolute $FC;
const
  SEG308 = 0;  m_SEG308 = 1;  // LCD memory bit segment
  SEG309 = 1;  m_SEG309 = 2;  // LCD memory bit segment
  SEG310 = 2;  m_SEG310 = 4;  // LCD memory bit segment
  SEG311 = 3;  m_SEG311 = 8;  // LCD memory bit segment
  SEG312 = 4;  m_SEG312 = 16;  // LCD memory bit segment
  SEG313 = 5;  m_SEG313 = 32;  // LCD memory bit segment
  SEG314 = 6;  m_SEG314 = 64;  // LCD memory bit segment
  SEG315 = 7;  m_SEG315 = 128;  // LCD memory bit segment

type
  TLCDDR17set = bitpacked set of (e_SEG316, e_SEG317, e_SEG318, e_SEG319, e_SEG320, e_SEG321, e_SEG322, e_SEG323);
  TLCDDR17rec = bitpacked record
    SEG316,
    SEG317,
    SEG318,
    SEG319,
...
var
  ...
  LCDDR17set: TLCDDR17set absolute $FD;
  LCDDR17rec: TLCDDR17rec absolute $FD;
const
  SEG316 = 0;  m_SEG316 = 1;  // LCD memory bit segment
  SEG317 = 1;  m_SEG317 = 2;  // LCD memory bit segment
  SEG318 = 2;  m_SEG318 = 4;  // LCD memory bit segment
  SEG319 = 3;  m_SEG319 = 8;  // LCD memory bit segment
  SEG320 = 4;  m_SEG320 = 16;  // LCD memory bit segment
  SEG321 = 5;  m_SEG321 = 32;  // LCD memory bit segment
  SEG322 = 6;  m_SEG322 = 64;  // LCD memory bit segment
  SEG323 = 7;  m_SEG323 = 128;  // LCD memory bit segment

type
  TLCDDR18set = bitpacked set of (e_SEG324, e_SEG325, e_SEG326, e_SEG327, e_SEG328, e_SEG329, e_SEG330, e_SEG331);
  TLCDDR18rec = bitpacked record
    SEG324,
    SEG325,
    SEG326,
    SEG327,
...
var
  ...
  LCDDR18set: TLCDDR18set absolute $FE;
  LCDDR18rec: TLCDDR18rec absolute $FE;
const
  SEG324 = 0;  m_SEG324 = 1;  // LCD memory bit segment
  SEG325 = 1;  m_SEG325 = 2;  // LCD memory bit segment
  SEG326 = 2;  m_SEG326 = 4;  // LCD memory bit segment
  SEG327 = 3;  m_SEG327 = 8;  // LCD memory bit segment
  SEG328 = 4;  m_SEG328 = 16;  // LCD memory bit segment
  SEG329 = 5;  m_SEG329 = 32;  // LCD memory bit segment
  SEG330 = 6;  m_SEG330 = 64;  // LCD memory bit segment
  SEG331 = 7;  m_SEG331 = 128;  // LCD memory bit segment
  // typedefs = 68
