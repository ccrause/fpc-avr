...
type
  TFSENset = bitpacked set of (e_SDPU, e_SDEN, e_GAEN, e_PEEN, e_ASEN);
...
type
  TSUPCRset = bitpacked set of (e_AVCCRM, e_AVCCLM, e_PVEN, e_PV22, e_PVDIC, e_AVEN, e_AVDIC);
...
const
  ...
  PV22 = 3;  m_PV22 = 8;  // Power Amplifier Voltage 2.2V
  PVDIC = 4;  m_PVDIC = 16;  // Power Amplifier Regulator Double Internal Current
  AVEN = 5;  m_AVEN = 32;  // AVCC Enable
  AVDIC = 6;  m_AVDIC = 64;  // AVCC Double Internal Current

type
  TSUPCA1set = bitpacked set of (e_DVCAL0, e_DVCAL1, e_VVCAL0, e_VVCAL1, e_AVCAL0, e_AVCAL1, e_PVCAL0, e_PVCAL1);
...
const
  ...
  PVCAL0 = 6;  m_PVCAL0 = 64;  // PA Regulator Voltage Calibration
  PVCAL1 = 7;  m_PVCAL1 = 128;  // PA Regulator Voltage Calibration
...
const
  ...
  SSMTGE = 2;  m_SSMTGE = 4;  // SSM Tx Gauss Shaping Enable
  SSMTPE = 3;  m_SSMTPE = 8;  // SSM Tx Preemphasis Enable
  SSMPVE = 4;  m_SSMPVE = 16;  // SSM PA Voltage Enable
  SSMTAE = 5;  m_SSMTAE = 32;  // SSM Tx ASK-Shaping Enable
...
type
  TFEPACset = bitpacked set of (e_FEPAC0, e_FEPAC1, e_FEPAC2, e_FEPAC3, e_FEPAC4, e_FEPAC5, e_FEPAC6, e_FEPAC7);
...
var
  FEPAC: byte absolute $105;  // RF Front End Power Amplifier Control
  FEPACset: TFEPACset absolute $105;
  FEPACrec: TFEPACrec absolute $105;
const
  FEPAC0 = 0;  m_FEPAC0 = 1;  // RF Front End Power Amplifier Control
  FEPAC1 = 1;  m_FEPAC1 = 2;  // RF Front End Power Amplifier Control
  FEPAC2 = 2;  m_FEPAC2 = 4;  // RF Front End Power Amplifier Control
  FEPAC3 = 3;  m_FEPAC3 = 8;  // RF Front End Power Amplifier Control
  FEPAC4 = 4;  m_FEPAC4 = 16;  // RF Front End Power Amplifier Control
  FEPAC5 = 5;  m_FEPAC5 = 32;  // RF Front End Power Amplifier Control
  FEPAC6 = 6;  m_FEPAC6 = 64;  // RF Front End Power Amplifier Control
  FEPAC7 = 7;  m_FEPAC7 = 128;  // RF Front End Power Amplifier Control
...
var
  TMFSM: byte absolute $12F;  // Tx Modulator Finite State Machine
  TMFSMset: TTMFSMset absolute $12F;
  TMFSMrec: TTMFSMrec absolute $12F;
const
...
var
  TMCR: word absolute $130;  // Tx Modulator CRC Result
  TMCRL: byte absolute $130;
  TMCRH: byte absolute $131;
  TMCSB: byte absolute $132;  // Tx Modulator CRC Skip Bit Number
  TMCI: word absolute $134;  // Tx Modulator CRC Init Value
  TMCIL: byte absolute $134;
  TMCIH: byte absolute $135;
  TMCP: word absolute $135;  // Tx Modulator CRC Polynomial
  TMCPL: byte absolute $135;
  TMCPH: byte absolute $136;
  TMSHR: byte absolute $137;  // Tx Modulator Shift Register
  TMTL: word absolute $138;  // Tx Modulator Telegram Length
  TMTLL: byte absolute $138;
  TMTLH: byte absolute $139;
...
var
  TMSSC: byte absolute $13A;  // Tx Modulator Stop Sequence Configuration
  TMSSCset: TTMSSCset absolute $13A;
  TMSSCrec: TTMSSCrec absolute $13A;
const
...
var
  TMSR: byte absolute $13B;  // Tx Modulator Status Register
  TMSRset: TTMSRset absolute $13B;
  TMSRrec: TTMSRrec absolute $13B;
const
  TMTCF = 0;  m_TMTCF = 1;  // Tx Modulator Transmission Complete Status Flag

type
  TTMCR2set = bitpacked set of (e_TMCRCE, e_TMCRCL0, e_TMCRCL1, e_TMNRZE, e_TMPOL, e_TMSSE, e_TMLSB);
...
var
  TMCR2: byte absolute $13C;  // Tx Modulator Control Register 2
  TMCR2set: TTMCR2set absolute $13C;
  TMCR2rec: TTMCR2rec absolute $13C;
const
  ...
  TMLSB = 6;  m_TMLSB = 64;  // Tx Modulator Most Significant Bit First
...
var
  TMCR1: byte absolute $13D;  // Tx Modulator Control Register 1
  TMCR1set: TTMCR1set absolute $13D;
  TMCR1rec: TTMCR1rec absolute $13D;
const
