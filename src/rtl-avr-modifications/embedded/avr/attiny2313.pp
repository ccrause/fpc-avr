...
type
  TUCSRCset = bitpacked set of (e_UCPOL, e_UCSZ0, e_UCSZ1, e_USBS, e_UPM0, e_UPM1, e_UMSEL);
...
var
  ...
  PCMSK: byte absolute $40;  // Pin-Change Mask register
...
type
  TEIFRset = bitpacked set of (e_PCIF=5, e_INTF0, e_INTF1);
...
var
  EIFR: byte absolute $5A;  // Extended Interrupt Flag Register
  EIFRset: TEIFRset absolute $5A;
  EIFRrec: TEIFRrec absolute $5A;
const
  PCIF = 5;  m_PCIF = 32;
