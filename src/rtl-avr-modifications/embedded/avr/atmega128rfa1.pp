...
type
  TADCSRCset = bitpacked set of (e_ADSUT0, e_ADSUT1, e_ADSUT2, e_ADSUT3, e_ADSUT4, e_Res0, e_ADTHT0, e_ADTHT1);
...
type
  TSCCR1set = bitpacked set of (e_SCENBO);
...
var
  DRTRAM3: byte absolute $132;  // Data Retention Configuration Register of SRAM 3
  DRTRAM2: byte absolute $133;  // Data Retention Configuration Register of SRAM 2
  DRTRAM1: byte absolute $134;  // Data Retention Configuration Register of SRAM 1
...
var
  DRTRAM0: byte absolute $135;  // Data Retention Configuration Register of SRAM 0
...
type
  TTRX_CTRL_1set = bitpacked set of (e_TX_AUTO_CRC_ON=5, e_IRQ_2_EXT_EN, e_PA_EXT_EN);
...
type
  TPHY_TX_PWRset = bitpacked set of (e_TX_PWR0, e_TX_PWR1, e_TX_PWR2, e_TX_PWR3, e_PA_LT0, e_PA_LT1, e_PA_BUF_LT0, e_PA_BUF_LT1);
...
const
  ...
  PA_LT0 = 4;  m_PA_LT0 = 16;  // Power Amplifier Lead Time
  PA_LT1 = 5;  m_PA_LT1 = 32;  // Power Amplifier Lead Time
  PA_BUF_LT0 = 6;  m_PA_BUF_LT0 = 64;  // Power Amplifier Buffer Lead Time
  PA_BUF_LT1 = 7;  m_PA_BUF_LT1 = 128;  // Power Amplifier Buffer Lead Time
...
type
  TRX_SYNset = bitpacked set of (e_RX_PDT_LEVEL0, e_RX_PDT_LEVEL1, e_RX_PDT_LEVEL2, e_RX_PDT_LEVEL3, e_RX_PDT_DIS=7);
