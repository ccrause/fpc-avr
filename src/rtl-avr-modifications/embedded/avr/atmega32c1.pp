...
const
  CANTIM0 = 0;  m_CANTIM0 = 1;  // CAN Timer bits
  CANTIM1 = 1;  m_CANTIM1 = 2;  // CAN Timer bits
  CANTIM2 = 2;  m_CANTIM2 = 4;  // CAN Timer bits
  CANTIM3 = 3;  m_CANTIM3 = 8;  // CAN Timer bits
  CANTIM4 = 4;  m_CANTIM4 = 16;  // CAN Timer bits
  CANTIM5 = 5;  m_CANTIM5 = 32;  // CAN Timer bits
  CANTIM6 = 6;  m_CANTIM6 = 64;  // CAN Timer bits
  CANTIM7 = 7;  m_CANTIM7 = 128;  // CAN Timer bits
