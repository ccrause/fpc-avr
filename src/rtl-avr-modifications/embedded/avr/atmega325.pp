...
type
  TPRRset = bitpacked set of (e_PRADC, e_PRUSART0, e_PRSPI, e_PRTIM1);
...
const
  PCINT8 = 0;  m_PCINT8 = 1;  // Pin Change Mask bits
  PCINT9 = 1;  m_PCINT9 = 2;  // Pin Change Mask bits
  PCINT10 = 2;  m_PCINT10 = 4;  // Pin Change Mask bits
  PCINT11 = 3;  m_PCINT11 = 8;  // Pin Change Mask bits
  PCINT12 = 4;  m_PCINT12 = 16;  // Pin Change Mask bits
  PCINT13 = 5;  m_PCINT13 = 32;  // Pin Change Mask bits
  PCINT14 = 6;  m_PCINT14 = 64;  // Pin Change Mask bits
  PCINT15 = 7;  m_PCINT15 = 128;  // Pin Change Mask bits
