...
type
  TSCCR1set = bitpacked set of (e_SCENBO, e_SCEECLK, e_SCCKDIV0, e_SCCKDIV1, e_SCCKDIV2, e_SCBTSM, e_Res5, e_Res6);
...
const
  ...
  Res5 = 6;  m_Res5 = 64;  // Reserved Bit
  Res6 = 7;  m_Res6 = 128;  // Reserved Bit
