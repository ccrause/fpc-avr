...
type
  TSPDR0set = bitpacked set of (e_SPDR00, e_SPDR01, e_SPDR02, e_SPDR03, e_SPDR04, e_SPDR05, e_SPDR06, e_SPDR07);
  TSPDR0rec = bitpacked record
    SPDR00,
    SPDR01,
    SPDR02,
    SPDR03,
...
var
  ...
  SPDR0set: TSPDR0set absolute $4E;
  SPDR0rec: TSPDR0rec absolute $4E;
const
  SPDR00 = 0;  m_SPDR00 = 1;  // SPI Data bits
  SPDR01 = 1;  m_SPDR01 = 2;  // SPI Data bits
  SPDR02 = 2;  m_SPDR02 = 4;  // SPI Data bits
  SPDR03 = 3;  m_SPDR03 = 8;  // SPI Data bits
  SPDR04 = 4;  m_SPDR04 = 16;  // SPI Data bits
  SPDR05 = 5;  m_SPDR05 = 32;  // SPI Data bits
  SPDR06 = 6;  m_SPDR06 = 64;  // SPI Data bits
  SPDR07 = 7;  m_SPDR07 = 128;  // SPI Data bits
...
const
  OCR2A0 = 0;  m_OCR2A0 = 1;  // Timer/Counter0 Output Compare A bits
  OCR2A1 = 1;  m_OCR2A1 = 2;  // Timer/Counter0 Output Compare A bits
  OCR2A2 = 2;  m_OCR2A2 = 4;  // Timer/Counter0 Output Compare A bits
  OCR2A3 = 3;  m_OCR2A3 = 8;  // Timer/Counter0 Output Compare A bits
  OCR2A4 = 4;  m_OCR2A4 = 16;  // Timer/Counter0 Output Compare A bits
  OCR2A5 = 5;  m_OCR2A5 = 32;  // Timer/Counter0 Output Compare A bits
  OCR2A6 = 6;  m_OCR2A6 = 64;  // Timer/Counter0 Output Compare A bits
  OCR2A7 = 7;  m_OCR2A7 = 128;  // Timer/Counter0 Output Compare A bits
...
const
  UBRR10 = 0;  m_UBRR10 = 1;  // USART Baud Rate bits
  UBRR11 = 1;  m_UBRR11 = 2;  // USART Baud Rate bits
  UBRR12 = 2;  m_UBRR12 = 4;  // USART Baud Rate bits
  UBRR13 = 3;  m_UBRR13 = 8;  // USART Baud Rate bits
  UBRR14 = 4;  m_UBRR14 = 16;  // USART Baud Rate bits
  UBRR15 = 5;  m_UBRR15 = 32;  // USART Baud Rate bits
  UBRR16 = 6;  m_UBRR16 = 64;  // USART Baud Rate bits
  UBRR17 = 7;  m_UBRR17 = 128;  // USART Baud Rate bits
