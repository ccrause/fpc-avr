...
const
  ...
  MUX5 = 3;  m_MUX5 = 8;  // Analog Channel and Gain Selection Bit 5
  REFS2 = 4;  m_REFS2 = 16;  // Reference Selection Bit
...
type
  TTCCR1Bset = bitpacked set of (e_CS10, e_CS11, e_CS12, e_CS13, e_DTPS10, e_DTPS11, e_PSR1);
