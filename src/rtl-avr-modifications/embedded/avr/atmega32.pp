...
const
  ...
  TWA0 = 1;  m_TWA0 = 2;  // TWI address bits
  TWA1 = 2;  m_TWA1 = 4;  // TWI address bits
  TWA2 = 3;  m_TWA2 = 8;  // TWI address bits
  TWA3 = 4;  m_TWA3 = 16;  // TWI address bits
  TWA4 = 5;  m_TWA4 = 32;  // TWI address bits
  TWA5 = 6;  m_TWA5 = 64;  // TWI address bits
  TWA6 = 7;  m_TWA6 = 128;  // TWI address bits
...
type
  TUBRRHset = bitpacked set of (e_UCPOL, e_UCSZ0, e_UCSZ1, e_USBS, e_UPM0, e_UPM1, e_UMSEL, e_URSEL);
...
var
  UBRRH: byte absolute $40;  // USART Baud Rate Register Hight Byte
...
type
  TASSRset = bitpacked set of (e_TCR2UB, e_OCR2UB, e_TCN2UB, e_AS2, e_OCDR4, e_OCDR5, e_OCDR6, e_OCDR7);
...
const
  ...
  WGM21 = 3;  m_WGM21 = 8;  // Clear Timer/Counter2 on Compare Match
  COM20 = 4;  m_COM20 = 16;  // Compare Output Mode bits
  COM21 = 5;  m_COM21 = 32;  // Compare Output Mode bits
  WGM20 = 6;  m_WGM20 = 64;  // Pulse Width Modulator Enable
...
const
  ...
  ADTS0 = 5;  m_ADTS0 = 32;  // ADC Auto Trigger Source
  ADTS1 = 6;  m_ADTS1 = 64;  // ADC Auto Trigger Source
  ADTS2 = 7;  m_ADTS2 = 128;  // ADC Auto Trigger Source
...
const
  ...
  WGM00 = 6;  m_WGM00 = 64;  // Waveform Generation Mode
...
type
  TMCUCRset = bitpacked set of (e_ISC00, e_ISC01, e_ISC10, e_ISC11, e_SM0, e_SM1, e_SM2, e_SE);
...
const
  ...
  SM2 = 6;  m_SM2 = 64;  // Sleep Mode Select
  SE = 7;  m_SE = 128;  // Sleep Enable
...
procedure SPI_STC_ISR; external name 'SPI_STC_ISR'; // Interrupt 12 Serial Transfer Complete
