...
procedure T2COMINT_ISR; external name 'T2COMINT_ISR'; // Interrupt 14 Timer/Counter2 Compare Match Interrupt
procedure T2OVFINT_ISR; external name 'T2OVFINT_ISR'; // Interrupt 15 Timer/Counter2 Overflow Interrupt
procedure T1INT_ISR; external name 'T1INT_ISR'; // Interrupt 16 Timer 1 Interval Interrupt
procedure SPISTC_ISR; external name 'SPISTC_ISR'; // Interrupt 17 SPI Serial Transfer Complete Interrupt
procedure TMRXBINT_ISR; external name 'TMRXBINT_ISR'; // Interrupt 18 Timer Modulator SSI Receive Buffer Interrupt
procedure TMTXBINT_ISR; external name 'TMTXBINT_ISR'; // Interrupt 19 Timer Modulator SSI Transmit Buffer Interrupt
procedure TMTXCINT_ISR; external name 'TMTXCINT_ISR'; // Interrupt 20 Timer Modulator Transmit Complete Interrupt
procedure AESINT_ISR; external name 'AESINT_ISR'; // Interrupt 21 AES Interrupt
procedure LFRSSINT_ISR; external name 'LFRSSINT_ISR'; // Interrupt 22 LF-Receiver RSSi measurement Interrupt
procedure LFSDINT_ISR; external name 'LFSDINT_ISR'; // Interrupt 23 LF-Receiver Signal Detect Interrupt
procedure LFMDINT_ISR; external name 'LFMDINT_ISR'; // Interrupt 24 LF-Receiver Manchester Decoder error Interrupt 
procedure EXCMINT_ISR; external name 'EXCMINT_ISR'; // Interrupt 25 External Input Clock Monitoring Interrupt
procedure EXXMINT_ISR; external name 'EXXMINT_ISR'; // Interrupt 26 External XTAL Oscillator Break Down Interrupt
procedure RTCINT_ISR; external name 'RTCINT_ISR'; // Interrupt 27 Real Time Clock Interrupt
procedure EEREADY_ISR; external name 'EEREADY_ISR'; // Interrupt 28 EEPROM Ready Interrupt
procedure SPMREADY_ISR; external name 'SPMREADY_ISR'; // Interrupt 29 Store Program Memory Ready 
