...
type
  TPORTEset = bitpacked set of (e_PE0, e_PE1, e_PE2, e_PE3, e_PE4, e_PE5, e_PE6);
...
type
  TTIFR3set = bitpacked set of (e_TOV3, e_OCF3A, e_OCF3B, e_ICF3=5);
...
const
  TOV3 = 0;  m_TOV3 = 1;  // Timer/Counter1 Overflow Flag
  OCF3A = 1;  m_OCF3A = 2;  // Timer/Counter1 Output Compare A Match Flag
  OCF3B = 2;  m_OCF3B = 4;  // Timer/Counter1 Output Compare B Match Flag
  ICF3 = 5;  m_ICF3 = 32;  // Timer/Counter1 Input Capture Flag

type
  TTIFR4set = bitpacked set of (e_TOV4, e_OCF4A, e_OCF4B, e_ICF4=5);
...
const
  TOV4 = 0;  m_TOV4 = 1;  // Timer/Counter1 Overflow Flag
  OCF4A = 1;  m_OCF4A = 2;  // Timer/Counter1 Output Compare A Match Flag
  OCF4B = 2;  m_OCF4B = 4;  // Timer/Counter1 Output Compare B Match Flag
  ICF4 = 5;  m_ICF4 = 32;  // Timer/Counter1 Input Capture Flag

type
  TPCIFRset = bitpacked set of (e_PCIF0, e_PCIF1, e_PCIF2, e_PCIF3, e_PCIF4);
...
const
  ...
  PCIF4 = 4;  m_PCIF4 = 16;  // Pin Change Interrupt Flags
...
type
  TPRR2set = bitpacked set of (e_PRTWI1, e_PRSPI1, e_PRUSART2, e_PRPTC);
...
const
  PRTWI1 = 0;  m_PRTWI1 = 1;  // Power Reduction TWI1
  PRSPI1 = 1;  m_PRSPI1 = 2;  // Power Reduction Serial Peripheral Interface 1
  PRUSART2 = 2;  m_PRUSART2 = 4;  // Power Reduction USART2
  PRPTC = 3;  m_PRPTC = 8;  // Power Reduction Peripheral Touch Controller
...
const
  ...
  PRSPI0 = 2;  m_PRSPI0 = 4;  // Power Reduction Serial Peripheral Interface 0
...
type
  TPRR1set = bitpacked set of (e_PRTIM3, e_PRTIM4);
...
const
  ...
  PRTIM4 = 1;  m_PRTIM4 = 2;  // Power Reduction Timer/Counter4
...
type
  TPCICRset = bitpacked set of (e_PCIE0, e_PCIE1, e_PCIE2, e_PCIE3, e_PCIE4);
...
const
  ...
  PCIE4 = 4;  m_PCIE4 = 16;  // Pin Change Interrupt Enables
...
const
  TOIE3 = 0;  m_TOIE3 = 1;  // Timer/Counter1 Overflow Interrupt Enable
  OCIE3A = 1;  m_OCIE3A = 2;  // Timer/Counter1 Output Compare A Match Interrupt Enable
  OCIE3B = 2;  m_OCIE3B = 4;  // Timer/Counter1 Output Compare B Match Interrupt Enable
  ICIE3 = 5;  m_ICIE3 = 32;  // Timer/Counter1 Input Capture Interrupt Enable
...
const
  TOIE4 = 0;  m_TOIE4 = 1;  // Timer/Counter1 Overflow Interrupt Enable
  OCIE4A = 1;  m_OCIE4A = 2;  // Timer/Counter1 Output Compare A Match Interrupt Enable
  OCIE4B = 2;  m_OCIE4B = 4;  // Timer/Counter1 Output Compare B Match Interrupt Enable
  ICIE4 = 5;  m_ICIE4 = 32;  // Timer/Counter1 Input Capture Interrupt Enable

var
  PCMSK3: byte absolute $73;  // Pin Change Mask Register 3

type
  TPCMSK4set = bitpacked set of (e_PCINT32, e_PCINT33, e_PCINT34, e_PCINT35, e_PCINT36, e_PCINT37, e_PCINT38);
  TPCMSK4rec = bitpacked record
    PCINT32,
    PCINT33,
    PCINT34,
    PCINT35,
...
var
  ...
  PCMSK4set: TPCMSK4set absolute $75;
  PCMSK4rec: TPCMSK4rec absolute $75;
const
  PCINT32 = 0;  m_PCINT32 = 1;  // Pin Change Enable Masks
  PCINT33 = 1;  m_PCINT33 = 2;  // Pin Change Enable Masks
  PCINT34 = 2;  m_PCINT34 = 4;  // Pin Change Enable Masks
  PCINT35 = 3;  m_PCINT35 = 8;  // Pin Change Enable Masks
  PCINT36 = 4;  m_PCINT36 = 16;  // Pin Change Enable Masks
  PCINT37 = 5;  m_PCINT37 = 32;  // Pin Change Enable Masks
  PCINT38 = 6;  m_PCINT38 = 64;  // Pin Change Enable Masks
...
type
  TADCSRBset = bitpacked set of (e_ADTS0, e_ADTS1, e_ADTS2, e_ACME=6, e_GPIOEN);
...
const
  ...
  GPIOEN = 7;  m_GPIOEN = 128;  // Enable GPIO function of PE4
...
const
  ...
  COM3B0 = 4;  m_COM3B0 = 16;  // Compare Output Mode 1B, bits
  COM3B1 = 5;  m_COM3B1 = 32;  // Compare Output Mode 1B, bits
...
const
  CS30 = 0;  m_CS30 = 1;  // Clock Select1 bits
  CS31 = 1;  m_CS31 = 2;  // Clock Select1 bits
  CS32 = 2;  m_CS32 = 4;  // Clock Select1 bits
  ICES3 = 6;  m_ICES3 = 64;  // Input Capture 1 Edge Select
  ICNC3 = 7;  m_ICNC3 = 128;  // Input Capture 1 Noise Canceler
...
const
  WGM40 = 0;  m_WGM40 = 1;  // Pulse Width Modulator Select Bits
  WGM41 = 1;  m_WGM41 = 2;  // Pulse Width Modulator Select Bits
  COM4B0 = 4;  m_COM4B0 = 16;  // Compare Output Mode 1B, bits
  COM4B1 = 5;  m_COM4B1 = 32;  // Compare Output Mode 1B, bits
...
const
  CS40 = 0;  m_CS40 = 1;  // Clock Select1 bits
  CS41 = 1;  m_CS41 = 2;  // Clock Select1 bits
  CS42 = 2;  m_CS42 = 4;  // Clock Select1 bits
  ICES4 = 6;  m_ICES4 = 64;  // Input Capture 1 Edge Select
  ICNC4 = 7;  m_ICNC4 = 128;  // Input Capture 1 Noise Canceler
...
type
  TTWSR0set = bitpacked set of (e_TWPS0, e_TWPS1, e_TWS03=3, e_TWS04, e_TWS05, e_TWS06, e_TWS07);
...
const
  ...
  TWS03 = 3;  m_TWS03 = 8;  // TWI Status
  TWS04 = 4;  m_TWS04 = 16;  // TWI Status
  TWS05 = 5;  m_TWS05 = 32;  // TWI Status
  TWS06 = 6;  m_TWS06 = 64;  // TWI Status
  TWS07 = 7;  m_TWS07 = 128;  // TWI Status
...
type
  TTWAMR0set = bitpacked set of (e_TWAM00=1, e_TWAM01, e_TWAM02, e_TWAM03, e_TWAM04, e_TWAM05, e_TWAM06);
...
const
  ...
  TWAM01 = 2;  m_TWAM01 = 4;
  TWAM02 = 3;  m_TWAM02 = 8;
  TWAM03 = 4;  m_TWAM03 = 16;
  TWAM04 = 5;  m_TWAM04 = 32;
  TWAM05 = 6;  m_TWAM05 = 64;
  TWAM06 = 7;  m_TWAM06 = 128;

type
  TUCSR0Aset = bitpacked set of (e_MPCM, e_U2X, e_UPE, e_DOR, e_FE, e_UDRE, e_TXC, e_RXC);
...
type
  TUCSR0Bset = bitpacked set of (e_TXB8, e_RXB8, e_UCSZ2, e_TXEN, e_RXEN, e_UDRIE, e_TXCIE, e_RXCIE);
...
type
  TUCSR0Cset = bitpacked set of (e_UCPOL, e_UCSZ0, e_UCSZ1, e_USBS, e_UPM0, e_UPM1, e_UMSEL0, e_UMSEL1);
...
const
  ...
  RXS = 6;  m_RXS = 64;  // Start Frame Detect Flag
  RXSIE = 7;  m_RXSIE = 128;  // RX Start Frame Interrupt Enable
