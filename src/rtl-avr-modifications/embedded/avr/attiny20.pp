...
var
  ...
  PCMSK1set: TPCMSK1set absolute $0A;
  PCMSK1rec: TPCMSK1rec absolute $0A;
const
...
type
  TGIFRset = bitpacked set of (e_INTF0, e_PCIF0=4, e_PCIF1);
...
type
  TGIMSKset = bitpacked set of (e_INT0, e_PCIE0=4, e_PCIE1);
...
var
  ICR1: word absolute $1A;  // Input Capture Register  Bytes
  ICR1L: byte absolute $1A;
  ICR1H: byte absolute $1B;
  OCR1B: word absolute $1C;  // Timer/Counter1 Output Compare Register B 
  OCR1BL: byte absolute $1C;
  OCR1BH: byte absolute $1D;
  OCR1A: word absolute $1E;  // Timer/Counter 1 Output Compare Register A 
  OCR1AL: byte absolute $1E;
  OCR1AH: byte absolute $1F;
  TCNT1: word absolute $20;  // Timer/Counter1 
  TCNT1L: byte absolute $20;
  TCNT1H: byte absolute $21;
...
var
  ...
  TCCR1Cset: TTCCR1Cset absolute $22;
  TCCR1Crec: TTCCR1Crec absolute $22;
const
...
var
  TCCR1B: byte absolute $23;  // Timer/Counter1 Control Register B
  TCCR1Bset: TTCCR1Bset absolute $23;
  TCCR1Brec: TTCCR1Brec absolute $23;
const
...
var
  GTCCR: byte absolute $27;  // General Timer/Counter Control Register
  GTCCRset: TGTCCRset absolute $27;
  GTCCRrec: TGTCCRrec absolute $27;
const
