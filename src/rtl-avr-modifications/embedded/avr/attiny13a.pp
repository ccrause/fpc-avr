...
type
  TPRRset = bitpacked set of (e_PRADC, e_PRTIM0);
...
var
  PRR: byte absolute $45;  // Power Reduction Register
  PRRset: TPRRset absolute $45;
  PRRrec: TPRRrec absolute $45;
const
...
type
  TBODCRset = bitpacked set of (e_BODSE, e_BODS);
...
var
  BODCR: byte absolute $50;  // BOD Control Register
  BODCRset: TBODCRset absolute $50;
  BODCRrec: TBODCRrec absolute $50;
const
  BODSE = 0;  m_BODSE = 1;  // BOD Power-Down Sleep Enable
  BODS = 1;  m_BODS = 2;  // BOD Power-Down in Power-Down Sleep
