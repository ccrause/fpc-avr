...
const
  PCINT8 = 0;  m_PCINT8 = 1;  // Pin Change Mask
  PCINT9 = 1;  m_PCINT9 = 2;  // Pin Change Mask
  PCINT10 = 2;  m_PCINT10 = 4;  // Pin Change Mask
  PCINT11 = 3;  m_PCINT11 = 8;  // Pin Change Mask
  PCINT12 = 4;  m_PCINT12 = 16;  // Pin Change Mask
  PCINT13 = 5;  m_PCINT13 = 32;  // Pin Change Mask
  PCINT14 = 6;  m_PCINT14 = 64;  // Pin Change Mask
  PCINT15 = 7;  m_PCINT15 = 128;  // Pin Change Mask
...
type
  TLCDDR00set = bitpacked set of (e_SEG000, e_SEG001, e_SEG002, e_SEG003, e_SEG004, e_SEG005, e_SEG006, e_SEG007);
  TLCDDR00rec = bitpacked record
    SEG000,
    SEG001,
    SEG002,
    SEG003,
...
var
  ...
  LCDDR00set: TLCDDR00set absolute $EC;
  LCDDR00rec: TLCDDR00rec absolute $EC;
const
...
type
  TLCDDR01set = bitpacked set of (e_SEG008, e_SEG009, e_SEG010, e_SEG011, e_SEG012, e_SEG013, e_SEG014, e_SEG015);
  TLCDDR01rec = bitpacked record
    SEG008,
    SEG009,
    SEG010,
    SEG011,
...
var
  ...
  LCDDR01set: TLCDDR01set absolute $ED;
  LCDDR01rec: TLCDDR01rec absolute $ED;
const
...
type
  TLCDDR02set = bitpacked set of (e_SEG016, e_SEG017, e_SEG018, e_SEG019, e_SEG020, e_SEG021, e_SEG022, e_SEG023);
  TLCDDR02rec = bitpacked record
    SEG016,
    SEG017,
    SEG018,
    SEG019,
...
var
  ...
  LCDDR02set: TLCDDR02set absolute $EE;
  LCDDR02rec: TLCDDR02rec absolute $EE;
const
...
type
  TLCDDR03set = bitpacked set of (e_SEG024, e_SEG025, e_SEG026, e_SEG027, e_SEG028, e_SEG029, e_SEG030, e_SEG031);
  TLCDDR03rec = bitpacked record
    SEG024,
    SEG025,
    SEG026,
    SEG027,
...
var
  ...
  LCDDR03set: TLCDDR03set absolute $EF;
  LCDDR03rec: TLCDDR03rec absolute $EF;
const
...
type
  TLCDDR05set = bitpacked set of (e_SEG100, e_SEG101, e_SEG102, e_SEG103, e_SEG104, e_SEG105, e_SEG106, e_SEG107);
  TLCDDR05rec = bitpacked record
    SEG100,
    SEG101,
    SEG102,
    SEG103,
...
var
  ...
  LCDDR05set: TLCDDR05set absolute $F1;
  LCDDR05rec: TLCDDR05rec absolute $F1;
const
...
type
  TLCDDR06set = bitpacked set of (e_SEG108, e_SEG109, e_SEG110, e_SEG111, e_SEG112, e_SEG113, e_SEG114, e_SEG115);
  TLCDDR06rec = bitpacked record
    SEG108,
    SEG109,
    SEG110,
    SEG111,
...
var
  ...
  LCDDR06set: TLCDDR06set absolute $F2;
  LCDDR06rec: TLCDDR06rec absolute $F2;
const
...
type
  TLCDDR07set = bitpacked set of (e_SEG116, e_SEG117, e_SEG118, e_SEG119, e_SEG120, e_SEG121, e_SEG122, e_SEG123);
  TLCDDR07rec = bitpacked record
    SEG116,
    SEG117,
    SEG118,
    SEG119,
...
var
  ...
  LCDDR07set: TLCDDR07set absolute $F3;
  LCDDR07rec: TLCDDR07rec absolute $F3;
const
...
type
  TLCDDR08set = bitpacked set of (e_SEG124, e_SEG125, e_SEG126, e_SEG127, e_SEG128, e_SEG129, e_SEG130, e_SEG131);
  TLCDDR08rec = bitpacked record
    SEG124,
    SEG125,
    SEG126,
    SEG127,
...
var
  ...
  LCDDR08set: TLCDDR08set absolute $F4;
  LCDDR08rec: TLCDDR08rec absolute $F4;
const
