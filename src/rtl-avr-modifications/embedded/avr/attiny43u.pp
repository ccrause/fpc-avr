...
type
  TDIDR0set = bitpacked set of (e_ADC0D, e_ADC1D, e_ADC2D, e_ADC3D, e_AIN0D, e_AIN1D);
...
const
  ...
  AIN0D = 4;  m_AIN0D = 16;  // Analog Comparator IO
  AIN1D = 5;  m_AIN1D = 32;  // Analog Comparator IO

type
  TADCSRBset = bitpacked set of (e_ADTS0, e_ADTS1, e_ADTS2, e_ADLAR=4, e_ACME=6, e_BVRON);
...
const
  ...
  BVRON = 7;  m_BVRON = 128;  // Boost Regulator Status Bit
...
type
  TADMUXset = bitpacked set of (e_MUX0, e_MUX1, e_MUX2, e_REFS=6);
...
type
  TTIFR1set = bitpacked set of (e_TOV1, e_OCF1A, e_OCF1B);
...
var
  TIFR1: byte absolute $2B;  // Timer/Counter1 Interrupt Flag Register
...
type
  TTIMSK1set = bitpacked set of (e_TOIE1, e_OCIE1A, e_OCIE1B);
...
var
  TIMSK1: byte absolute $2C;  // Timer/Counter Interrupt Mask Register
...
const
  ...
  OCIE1A = 1;  m_OCIE1A = 2;  // Timer/Counter1 Output Compare Match A Interrupt Enable
  OCIE1B = 2;  m_OCIE1B = 4;  // Timer/Counter1 Output Compare Match B Interrupt Enable
...
var
  ...
  PCMSK0: byte absolute $32;  // Pin Change Enable Mask Byte 0
...
var
  ...
  EEAR: byte absolute $3E;  // EEPROM Address Register
  PCMSK1: byte absolute $40;  // Pin Change Enable Mask Byte 1
...
var
  OCR1B: byte absolute $4B;  // Timer/Counter1 Output Compare Register B
  OCR1A: byte absolute $4C;  // Timer/Counter1 Output Compare Register A
  TCNT1: byte absolute $4D;  // Timer/Counter1

type
  TTCCR1Bset = bitpacked set of (e_CS10, e_CS11, e_CS12, e_WGM12, e_FOC1B=6, e_FOC1A);
...
var
  TCCR1B: byte absolute $4E;  // Timer/Counter Control Register B
...
const
  ...
  WGM12 = 3;  m_WGM12 = 8;  // Waveform Generation Mode bit 2
  FOC1B = 6;  m_FOC1B = 64;  // Force Output Compare B
  FOC1A = 7;  m_FOC1A = 128;  // Force Output Compare A
...
const
  ...
  COM1B0 = 4;  m_COM1B0 = 16;  // Compare Match Output B Mode bits
  COM1B1 = 5;  m_COM1B1 = 32;  // Compare Match Output B Mode bits
  COM1A0 = 6;  m_COM1A0 = 64;  // Compare Match Output A Mode bits
  COM1A1 = 7;  m_COM1A1 = 128;  // Compare Match Output A Mode bits
