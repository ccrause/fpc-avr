...
type
  TPORTCset = bitpacked set of (e_PC0, e_PC1, e_PC2, e_PC3, e_PC4);
...
type
  TEECRset = bitpacked set of (e_EERE, e_EEWE, e_EEMWE, e_EERIE, e_EEPM0, e_EEPM1, e_EELP);
...
const
  ...
  VMIM = 4;  m_VMIM = 16;  // Voltag Monitor Interrupt Mask bit
  VMPS = 5;  m_VMPS = 32;  // Voltage Monitor Power Supply Voltage Select Bit
  BODPD = 6;  m_BODPD = 64;  // Brown-Out Detection on Power-Down Bit
  BODLS = 7;  m_BODLS = 128;  // Brown-Out Detection Level Bit
...
type
  TPRR0set = bitpacked set of (e_PRT1=1, e_PRT2, e_PRT3, e_PRTM, e_PRCU, e_PRDS, e_PRVM);
...
type
  TCRCCRset = bitpacked set of (e_CRCN0, e_CRCN1, e_CRCN2, e_CRCSEL, e_REFLI, e_REFLO, e_CRCRS=7);
...
procedure VMINT_ISR; external name 'VMINT_ISR'; // Interrupt 5 Voltage Monitor Interrupt
procedure T0INT_ISR; external name 'T0INT_ISR'; // Interrupt 6 Timer0 Interval Interrupt
procedure T3CAPINT_ISR; external name 'T3CAPINT_ISR'; // Interrupt 7 Timer3 Capture Interrupt
procedure T3COMINT_ISR; external name 'T3COMINT_ISR'; // Interrupt 8 Timer3 Compare Match Interrupt
procedure T3OVFINT_ISR; external name 'T3OVFINT_ISR'; // Interrupt 9 Timer3 Overflow Interrupt
procedure T2COMINT_ISR; external name 'T2COMINT_ISR'; // Interrupt 10 Timer2 Compare Match Interrupt
procedure T2OVFINT_ISR; external name 'T2OVFINT_ISR'; // Interrupt 11 Timer2 Overflow Interrupt
procedure T1INT_ISR; external name 'T1INT_ISR'; // Interrupt 12 Timer1 Interval Interrupt
procedure SPISTC_ISR; external name 'SPISTC_ISR'; // Interrupt 13 SPI Serial Transfer Complete
procedure TMRXBINT_ISR; external name 'TMRXBINT_ISR'; // Interrupt 14 Timer Modulator SSI Receive Buffer Interrupt
procedure TMTXBINT_ISR; external name 'TMTXBINT_ISR'; // Interrupt 15 Timer Modulator SSI Transmit Buffer Interrupt
procedure TMTXCINT_ISR; external name 'TMTXCINT_ISR'; // Interrupt 16 Timer Modulator Transmit Complete Interrupt
procedure AESINT_ISR; external name 'AESINT_ISR'; // Interrupt 17 AES Interrupt
procedure EXCMINT_ISR; external name 'EXCMINT_ISR'; // Interrupt 18 External Input Clock Monitoring Interrupt
procedure EXXMINT_ISR; external name 'EXXMINT_ISR'; // Interrupt 19 External XTAL Oscillator Break Down Interrupt
procedure RTCINT_ISR; external name 'RTCINT_ISR'; // Interrupt 20 Real Time Clock Interrupt
procedure EEREADY_ISR; external name 'EEREADY_ISR'; // Interrupt 21 EEPROM Ready Interrupt
procedure SPMREADY_ISR; external name 'SPMREADY_ISR'; // Interrupt 22 Store Program Memory Ready 
