...
var
  LCD_DATA4_PORT: byte absolute PORTB;     // port for 4bit data bit 0
  LCD_DATA5_PORT: byte absolute PORTB;     // port for 4bit data bit 1
  LCD_DATA6_PORT: byte absolute PORTB;     // port for 4bit data bit 2
  LCD_DATA7_PORT: byte absolute PORTB;     // port for 4bit data bit 3
  LCD_RS_PORT: byte absolute PORTD;        // port for RS line
  LCD_RW_PORT: byte absolute PORTD;        // port for RW line
